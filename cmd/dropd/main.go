...
func exportAppStateAndTMValidators(
	...
	if height != -1 {
		gApp := app.NewDropApp(logger, db, traceStore, false, uint(1))
	...
	gApp := app.NewDropApp(logger, db, traceStore, true, uint(1))
	return gApp.ExportAppStateAndValidators(forZeroHeight, jailWhiteList)
}
