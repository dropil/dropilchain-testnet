...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a Dropd testnet",
...
Example:
	dropd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "dropd",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "dropcli",
...
func InitTestnet(cmd *cobra.Command, config *tmconfig.Config, cdc *codec.Codec,
	...
	dropConfig := srvconfig.DefaultConfig()
	dropConfig.MinGasPrices = minGasPrices
	...
	for i := 0; i < numValidators; i++ {
		...
		// TODO: Rename config file to server.toml as it's not particular to Drop
		// (REF: https://github.com/cosmos/cosmos-sdk/issues/4125).
		dropConfigFilePath := filepath.Join(nodeDir, "config/dropd.toml")
		srvconfig.WriteConfigFile(dropConfigFilePath, dropConfig)
	}
